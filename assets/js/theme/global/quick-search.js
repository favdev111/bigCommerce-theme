...
function btn_quickSearch_close() {
	$(".quickSearchResults .modal-close").on("click", function() {
        var this_elem = $(".navUser-action--quickSearch");
        var get_class = this_elem.data("parent-toggle-class");
        var elem_target = this_elem.data("parent-toggle-target");
		var elem_target_2 = this_elem.data("parent-toggle-target-2");
		
        	$("."+elem_target_2).removeClass(get_class);
			this_elem.parent().removeClass(get_class);
			this_elem.removeClass(get_class);
